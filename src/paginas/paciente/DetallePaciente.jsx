    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-gray-900 dark:bg-lime-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-lime-700 transition-colors text-sm font-medium"
        >
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block w-full text-center px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg transition-colors text-sm font-medium mt-4"
                >
                  Ver Perfil Completo
                </Link>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-gray-900 dark:bg-lime-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-lime-700 transition-colors text-sm font-medium"
              >
              ...
              <Link
                ...
                className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors text-sm font-medium"
              >
