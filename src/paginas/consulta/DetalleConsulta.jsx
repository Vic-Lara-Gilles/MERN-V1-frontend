      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-purple-600 dark:bg-purple-500 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors text-sm font-medium"
          >
          ...
          {puedeEditar && (
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gray-900 dark:bg-lime-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-lime-700 transition-colors text-sm font-medium"
            >
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gray-900 dark:bg-lime-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-lime-700 transition-colors text-sm font-medium"
              >
              ...
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 dark:bg-purple-500 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors text-sm font-medium"
              >
              ...
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors text-sm font-medium"
              >
