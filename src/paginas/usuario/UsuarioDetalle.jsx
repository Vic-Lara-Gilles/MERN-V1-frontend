...
const UsuarioDetalle = () => {
  ...
  if (cargando) {
    return <div className="p-8 text-center text-slate-500 dark:text-gray-400">Cargando usuario...</div>;
  }
  if (error) {
    return <div className="p-8 text-center text-red-500 dark:text-red-400">{error}</div>;
  }
  if (!usuario) {
    return <div className="p-8 text-center text-slate-500 dark:text-gray-400">Usuario no encontrado.</div>;
  }
